...
<head>
  ...
  <title>BGMI // BATTLE ROYALE</title>
  <meta name="description" content="BGMI — The ultimate survival and shooting competition.">
...
<body>
  ...
  <header class="navbar">
    <div class="wrap">
      <a class="brand" href="#home">BGMI</a>
      <nav class="navtabs">
  ...
  <main>
    ...
    <section class="hero" id="home">
      <div class="wrap">
        <div>
          <p class="hero-sub">// SURVIVAL OVERRIDE INITIATED. DROP INTO THE ZONE.</p>
          <h1 class="glitch-effect" data-text="BGMI">BGMI</h1>
          <h2 class="text-cyan">SEPTEMBER 25 | LIBRARY & SEMINAR HALL</h2>

          <p class="hero-sub" style="margin-top: 2rem;">
            Showcase your tactics, aim, and teamwork. Survive the battleground and claim the spotlight.
            <br><br>
            <span class="text-red">1ST PRIZE: 2 CERTIFICATES</span> &nbsp;|&nbsp;
            <span class="text-cyan">2ND PRIZE: 2 CERTIFICATES</span>
          </p>
        ...
        <div class="stack-panel">
          ...
          <div class="stack-visual">
            <div class="stack-frame champion">WINNER<span>()</span> &larr; CHICKEN DINNER</div>
            <div class="stack-frame">FINAL_ZONE<span>()</span></div>
            <div class="stack-frame">ROTATION<span>()</span></div>
            <div class="stack-frame">LOOT<span>()</span></div>
            <div class="stack-frame">DROP<span>()</span></div>
          </div>
        </div>
      </div>
    </section>
      ...
      <div class="wrap">
        ...
        <div class="terminal">
          ...
          <div class="terminal-body">
            ...
            <p>BGMI is a highly competitive Battle Royale tournament on <span class="highlight">September 25</span> at the <span class="highlight">Library & Seminar Hall</span>.</p>
            <p>Teams of 2 will compete in custom rooms. Coordination, gun skill, and map awareness are paramount.</p>
            <p>Bring your own device, ensure internet connectivity, and prepare to drop in.</p>
          </div>
        </div>
      </div>
    </section>
      ...
      <div class="wrap">
        ...
        <div class="frames">
          ...
          <article class="frame-card" data-depth="2">
            ...
            <h3 class="text-cyan">PHASE 2: MATCHES</h3>
            <p>The tournament begins. Follow the room details strictly and eliminate your opponents.</p>
          </article>
          ...
          <article class="frame-card" data-depth="3">
            ...
            <p>The top squads clash. The ultimate duo will be crowned the winner.</p>
          </article>
        </div>
      </div>
    </section>
      ...
      <div class="wrap">
        ...
        <div class="terminal">
          ...
          <div class="terminal-body">
            ...
            <p class="highlight" style="margin-bottom: 10px;">// BGMI SPECIFIC</p>
            <ul style="list-style-type: square; margin-left: 20px;">
              <li style="margin-bottom: 8px;">Registration fee: BGMI – ₹100 per team.</li>
              <li style="margin-bottom: 8px;">Participation is open to both Nirmalites and non-Nirmalites.</li>
              <li style="margin-bottom: 8px;">Only one team from each department is allowed (for Nirmalites). Each team must consist of exactly 2 players.</li>
              <li style="margin-bottom: 8px;">Online registration is not allowed for Nirmalites. Spot registration is mandatory.</li>
              <li style="margin-bottom: 8px;"><span class="highlight">ALLOWED:</span> M416, SCAR-L, Grenades (Nade), Level 3 Vest, and Level 3 Helmet.</li>
              <li style="margin-bottom: 8px;"><span class="highlight">NOT ALLOWED:</span> Any other weapons except M416 (M4) and SCAR-L.</li>
              <li style="margin-bottom: 8px;">Use of unfair means, hacks, cheats, exploits, or unauthorized third-party software is strictly prohibited.</li>
              <li style="margin-bottom: 8px;">Any player found violating the rules may be disqualified, and the decision of the organizers will be final.</li>
            </ul>
          </div>
        </div>
      </div>
        ...
        <div class="log">
          ...
          <div class="log-line">
            ...
            <div class="log-body">
              ...
              <p>Rooms are created. Drop in and secure your placement points.</p>
            </div>
          </div>
          <div class="log-line">
            ...
            <div class="log-body">
              ...
              <p>The final matches conclude and certificates are awarded to the winners.</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <section id="register">
      <div class="wrap">
        <div class="section-head">
          ...
          <p>₹100 per team. Payment required to confirm registration.</p>
        </div>
        ...
        <div id="paymentPortal" class="payment-portal hidden">
          ...
          <div class="form-container">
            ...
            <a class="btn btn-solid" href="https://docs.google.com/forms/d/e/1FAIpQLScJQMjXv_U4pn7RRBv-uYBsuroJ405o1DUndZRlbaSCXSrz0Q/viewform?usp=publish-editor" target="_blank" style="margin-top: 1rem;">
              ACCESS_GOOGLE_FORM()
            </a>
          </div>
        </div>
